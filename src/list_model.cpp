...
QVariant list_model::headerData(int section, Qt::Orientation orientation, int role)const{
...
bool list_model::setData(QModelIndex const& index, QVariant const& value, int role){
