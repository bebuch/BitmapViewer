...
//-----------------------------------------------------------------------------
#ifndef _bitmap_viewer__bitmap__hpp_INCLUDED_
#define _bitmap_viewer__bitmap__hpp_INCLUDED_
...
namespace bitmap_viewer{
	...
	public:
		...
		using point_type = bitmap_viewer::point< std::size_t >;

		/// \brief Type of bitmap size
		using size_type = bitmap_viewer::size< std::size_t >;
